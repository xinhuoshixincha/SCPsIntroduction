        ...
        success: function(xml){
            $(xml).find("SCP").each(function(i){
                ...
                if(level === scp_level || level === 'all'){
                    ...
                    $('table').append(
                        '<tr>' +
                        '<td>' +'<a href="SCPInformation.html?id='+id+'" target="_parent">'+ id +'</a>' +'</td>'+
                        '<td>' +'<a href="SCPInformation.html?id='+id+'" target="_parent">'+ name + '</a>' +'</td>'+
                        '<td>'+ '<a href="'+scp_level+'SCPs.html">' +scp_level + '</a>'+'</td>'+
                        '</tr>'
                    );
                }
            });
